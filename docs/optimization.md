...
This looks more familiar to javascript coders than the above one. It also is a fraction of a millisecond faster because it has no overhead for creating a call frame for function call;  
